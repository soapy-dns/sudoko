...
describe("getCandidatesToRemove", () => {
  it("should return an empty array when houseIndices is empty", () => {
    ...
    const result = getCandidatesToRemove({ houseIndices: [], board })
    expect(result).toEqual([])
  })

  it("should return used values from the houseIndices", () => {
    const board: EnhancedCell[] = [
      { val: 1, candidates: [] },
      { val: 2, candidates: [] },
      { val: 3, candidates: [] },
      { val: 4, candidates: [] },
    ...
    const result = getCandidatesToRemove({ houseIndices: [0, 1, 2], board })
  ...
  it("should handle a board with empty cells", () => {
    ...
    const result = getCandidatesToRemove({ houseIndices: [0, 1, 2, 3, 4, 5, 6, 7, 8], board })
